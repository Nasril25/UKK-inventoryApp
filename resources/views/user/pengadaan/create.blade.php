...
<div class="container mt-4">
    ...
    <form action="{{ route('user.pengadaan.store') }}" method="POST">
        ...
        <div class="mb-3">
            <label for="id_sub_kategori_asset" class="form-label">Sub Kategori Aset</label>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="nilai_barang" name="nilai_barang" placeholder="Masukkan nilai barang" required>
        </div>
        <div class="mb-3">
            <label for="usia_barang" class="form-label">Usia Barang (Bulan)</label>
            <input type="number" class="form-control" id="usia_barang" name="usia_barang" placeholder="Masukkan usia barang dalam bulan" required>
        </div>
        <div class="mb-3">
