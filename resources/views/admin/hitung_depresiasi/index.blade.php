...
<div class="container mt-4">
    ...
    <form action="{{ route('hitung_depresiasi.index') }}" method="GET" class="mb-4">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('hitung_depresiasi.show', $data->id_hitung_depresiasi) }}" class="btn btn-info btn-sm">Show</a>
                        <a href="{{ route('hitung_depresiasi.edit', $data->id_hitung_depresiasi) }}" class="btn btn-warning btn-sm">Edit</a>
                        <form action="{{ route('hitung_depresiasi.destroy', $data->id_hitung_depresiasi) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
