...
<div class="container mt-4">
    ...
    <a href="{{ route('hitung_depresiasi.index') }}" class="btn btn-secondary mb-3">Kembali</a>
    <form action="{{ route('hitung_depresiasi.update', $hitungDepresiasi->id_hitung_depresiasi) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-3">
